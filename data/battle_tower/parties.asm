...
;TODO fix later, all move dbs need to be dws
...
; BattleTowerMons group 3
	...
	dw MACHAMP
	db MIRACLEBERRY
	db BRICK_BREAK, ICE_PUNCH, EARTHQUAKE, FIRE_BLAST
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	dw PRIMEAPE
	db MIRACLEBERRY
	db LOW_KICK, POWERUPPUNCH, REVERSAL, FOCUS_ENERGY
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 4
	...
	dw PORYGON2
	db NO_ITEM
	db CONVERSION, RECOVER, PSYBEAM, THIEF
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	dw EXEGGUTOR
	db BRIGHTPOWDER
	db PSYCHIC_M, STOMP, PSYCH_UP, CONFUSION
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 5
	...
	dw MACHAMP
	db GOLD_BERRY
	db BRICK_BREAK, EARTHQUAKE, FIRE_BLAST, THUNDERPUNCH
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 40000
...
; BattleTowerMons group 6
	...
	dw MACHAMP
	db QUICK_CLAW
	db FIRE_PUNCH, BRICK_BREAK, THUNDERPUNCH, EARTHQUAKE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 7
	...
	dw PRIMEAPE
	db QUICK_CLAW
	db BRICK_BREAK, ICE_PUNCH, THUNDERPUNCH, ROCK_SLIDE
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 9
	...
	dw MACHAMP
	db QUICK_CLAW
	db BRICK_BREAK, DYNAMICPUNCH, FIRE_BLAST, EARTHQUAKE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 55000
...
; BattleTowerMons group 10
	...
	dw MACHAMP
	db QUICK_CLAW
	db BRICK_BREAK, EARTHQUAKE, HYPER_BEAM, DYNAMICPUNCH
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
