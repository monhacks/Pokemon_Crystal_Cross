...
; BattleTowerMons group 3
	...
	dw SLOWBRO
	db GOLD_BERRY
	dw BLIZZARD, AMNESIA, DREAM_EATER, ATTRACT
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	dw MACHAMP
	db MIRACLEBERRY
	dw BRICK_BREAK, ICE_PUNCH, EARTHQUAKE, FIRE_BLAST
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	dw PRIMEAPE
	db MIRACLEBERRY
	dw LOW_KICK, POWERUPPUNCH, REVERSAL, FOCUS_ENERGY
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 4
	...
	dw SNORLAX
	db QUICK_CLAW
	dw ATTRACT, SLAM, PSYCH_UP, EARTHQUAKE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	dw PORYGON2
	db NO_ITEM
	dw CONVERSION, RECOVER, PSYBEAM, THIEF
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	dw EXEGGUTOR
	db BRIGHTPOWDER
	dw PSYCHIC_M, STOMP, PSYCH_UP, CONFUSION
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 5
	...
	dw MACHAMP
	db GOLD_BERRY
	dw BRICK_BREAK, EARTHQUAKE, FIRE_BLAST, THUNDERPUNCH
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 40000
...
; BattleTowerMons group 6
	...
	dw MACHAMP
	db QUICK_CLAW
	dw FIRE_PUNCH, BRICK_BREAK, THUNDERPUNCH, EARTHQUAKE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	dw SNORLAX
	db PINK_BOW
	dw ROCK_SLIDE, SURF, SLAM, EARTHQUAKE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	dw GOLEM
	db BRIGHTPOWDER
	dw SELFDESTRUCT, EARTHQUAKE, FIRE_PUNCH, ROCK_SLIDE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 7
	...
	dw PRIMEAPE
	db QUICK_CLAW
	dw BRICK_BREAK, ICE_PUNCH, THUNDERPUNCH, ROCK_SLIDE
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	dw HITMONLEE
	db FOCUS_BAND
	dw REVERSAL, ENDURE, SLAM, MEGA_KICK
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	dw VENUSAUR
	db BRIGHTPOWDER
	dw SUNNY_DAY, SOLARBEAM, MORNING_SUN, HYPER_BEAM
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 8
	...
	dw TAUROS
	db GOLD_BERRY
	dw EARTHQUAKE, SLAM, IRON_TAIL, HYPER_BEAM
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	dw SLOWBRO
	db QUICK_CLAW
	dw AMNESIA, BLIZZARD, DREAM_EATER, PSYCHIC_M
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 55000
...
; BattleTowerMons group 9
	...
	dw MACHAMP
	db QUICK_CLAW
	dw BRICK_BREAK, DYNAMICPUNCH, FIRE_BLAST, EARTHQUAKE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 55000
	...
	dw MILTANK
	db LEFTOVERS
	dw MILK_DRINK, EARTHQUAKE, ATTRACT, SLAM
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 10
	...
	dw MACHAMP
	db QUICK_CLAW
	dw BRICK_BREAK, EARTHQUAKE, HYPER_BEAM, DYNAMICPUNCH
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
