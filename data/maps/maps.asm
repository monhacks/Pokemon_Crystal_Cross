...
; pointers to the first map of each map group
	...
	dw MapGroup_Radio
	dw MapGroup_Ruins
	dw MapGroup_Lighthouse
	dw MapGroup_Rocket
	dw MapGroup_Forest
	dw MapGroup_Underground
	dw MapGroup_Caves
	...
	dw MapGroup_Mewtwo
	dw MapGroup_Catallia
	dw MapGroup_SeviiOne
	dw MapGroup_SeviiTwo
	dw MapGroup_SeviiThree
	dw MapGroup_SeviiFour
	dw MapGroup_SeviiFive
	dw MapGroup_SeviiSix
	dw MapGroup_SeviiSeven
	dw MapGroup_CherrygroveNeo
	dw MapGroup_Underwater
	dw MapGroup_SecertBase
	dw MapGroup_JohtoSafari
...
MapGroup_Olivine:
	...
	map Route38, TILESET_JOHTO_38, ROUTE, LANDMARK_ROUTE_38, MUSIC_ROUTE_38, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route39, TILESET_JOHTO_38, ROUTE, LANDMARK_ROUTE_39, MUSIC_ROUTE_38, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map OlivineCity, TILESET_KANJO, TOWN, LANDMARK_OLIVINE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Caves:	
	...
	map TohjoFalls, TILESET_ICE_PATH_2, CAVE, LANDMARK_TOHJO_FALLS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
...
MapGroup_SafariZone:
	...
	map SafariZoneBeta, TILESET_PARK, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI
...
MapGroup_Ecruteak:
	...
	map EcruteakCity, TILESET_KANJO, TOWN, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map EcruteakSwarmHouse, TILESET_HOUSE, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Blackthorn:
	...
	map Route45, TILESET_JOHTO_45, ROUTE, LANDMARK_ROUTE_45, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_DRATINI_2
	map Route46, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_46, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map BlackthornCity, TILESET_KANJO, TOWN, LANDMARK_BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Violet:
	map Route32, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_32, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
	map Route35, TILESET_JOHTO_38, ROUTE, LANDMARK_ROUTE_35, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route36, TILESET_JOHTO_38, ROUTE, LANDMARK_ROUTE_36, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route37, TILESET_JOHTO_38, ROUTE, LANDMARK_ROUTE_37, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map VioletCity, TILESET_KANJO, TOWN, LANDMARK_VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Goldenrod:
	map Route34, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_34, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_GOLDSHORE
...
MapGroup_Fuchsia:
	map Route13, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_13, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map Route12, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	map Route40, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_40, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_NewBark:
	map Route26, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_26, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route27, TILESET_KANJO, ROUTE, LANDMARK_ROUTE_27, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route29, TILESET_JOHTO_29, ROUTE, LANDMARK_ROUTE_29, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map NewBarkTown, TILESET_JOHTO_29, TOWN, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_Cherrygrove:
	map Route30, TILESET_JOHTO_30, ROUTE, LANDMARK_ROUTE_30, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route31, TILESET_JOHTO_30, ROUTE, LANDMARK_ROUTE_31, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Mewtwo:	
	map MewtwoCave, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	
MapGroup_Catallia:
	map Route47, TILESET_JOHTO_29, ROUTE, LANDMARK_ROUTE_47, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map CatalliaTown, TILESET_JOHTO_30, TOWN, LANDMARK_CATALLIA_TOWN, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map CatalliaMart, TILESET_MART, INDOOR, LANDMARK_CATALLIA_TOWN, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CatalliaPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_CATALLIA_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CatalliaPoliceStation, TILESET_FACILITY, INDOOR, LANDMARK_CATALLIA_TOWN, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CatalliaHouse1, TILESET_HOUSE, INDOOR, LANDMARK_CATALLIA_TOWN, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CatalliaHouse2, TILESET_HOUSE, INDOOR, LANDMARK_CATALLIA_TOWN, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	
MapGroup_SeviiOne:
	map OneIsland, TILESET_SEVII_ONE, TOWN, LANDMARK_ONE_ISLAND, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map OneIslandMart, TILESET_MART, INDOOR, LANDMARK_ONE_ISLAND, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OneIslandPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_ONE_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map KindleRoad, TILESET_SEVII_ONE, ROUTE, LANDMARK_KINDLE_ROAD, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map MtEmber, TILESET_SEVII, ROUTE, LANDMARK_MT_EMBER, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_POND
	
MapGroup_SeviiTwo:
	map TwoIsland, TILESET_SEVII_TWO, TOWN, LANDMARK_TWO_ISLAND, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map TwoIslandMart, TILESET_MART, INDOOR, LANDMARK_TWO_ISLAND, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TwoIslandPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_TWO_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CapeBrink, TILESET_SEVII_TWO, ROUTE, LANDMARK_CAPE_BRINK, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	
MapGroup_SeviiThree:
	map ThreeIsland, TILESET_SEVII_THREE, TOWN, LANDMARK_THREE_ISLAND, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ThreeIslandMart, TILESET_MART, INDOOR, LANDMARK_THREE_ISLAND, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ThreeIslandPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_THREE_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BondBridge, TILESET_SEVII_THREE, ROUTE, LANDMARK_BOND_BRIDGE, MUSIC_ROUTE_38, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map BerryForest, TILESET_SEVII_FOREST, ROUTE, LANDMARK_BERRY_FOREST, MUSIC_ROUTE_2, FALSE, PALETTE_AUTO, FISHGROUP_POND

MapGroup_SeviiFour:
	map FourIsland, TILESET_SEVII_FOUR, TOWN, LANDMARK_FOUR_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FourIslandMart, TILESET_MART, INDOOR, LANDMARK_FOUR_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FourIslandPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_FOUR_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map IcefallCave, TILESET_SEVII, ROUTE, LANDMARK_ICEFALL_CAVE, MUSIC_DARK_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	
MapGroup_SeviiFive:
	map FiveIsland, TILESET_SEVII_FIVE, TOWN, LANDMARK_FIVE_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FiveIslandMart, TILESET_MART, INDOOR, LANDMARK_FIVE_ISLAND, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FiveIslandPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_FIVE_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FiveIsleMeadow, TILESET_SEVII_FIVE, ROUTE, LANDMARK_FIVE_ISLE_MEADOW, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FiveIsleRocketBase, TILESET_FACILITY, DUNGEON, LANDMARK_FIVE_ISLE_MEADOW, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	
MapGroup_SeviiSix:
	map SixIsland, TILESET_SEVII_SIX, TOWN, LANDMARK_SIX_ISLAND, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SixIslandMart, TILESET_MART, INDOOR, LANDMARK_SIX_ISLAND, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SixIslandPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_SIX_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map WaterPath, TILESET_SEVII_SIX, ROUTE, LANDMARK_WATER_PATH, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map RuinValley, TILESET_SEVII_SIX, ROUTE, LANDMARK_RUIN_VALLEY, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map PatternBush, TILESET_SEVII_FOREST, ROUTE, LANDMARK_PATTERN_BUSH, MUSIC_MT_MOON, FALSE, PALETTE_AUTO, FISHGROUP_POND
	
MapGroup_SeviiSeven:
	map SevenIsland, TILESET_SEVII_SEVEN, TOWN, LANDMARK_SEVEN_ISLAND, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SevenIslandMart, TILESET_MART, INDOOR, LANDMARK_SEVEN_ISLAND, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SevenIslandPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_SEVEN_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CanyonEntrance, TILESET_SEVII_SEVEN, ROUTE, LANDMARK_CANYON_ENTRANCE, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SevaultCanyon, TILESET_SEVII_SEVEN, ROUTE, LANDMARK_SEVAULT_CANYON, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	
MapGroup_CherrygroveNeo:
	map CherrygroveCity, TILESET_CHERRY_NEW, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map CherrygroveFerry, TILESET_CHERRY_FERRY, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map CherrygroveCafe, TILESET_GAME_CORNER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	
MapGroup_Underwater:
	map DiveTest, TILESET_UNDERWATER, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_DIVE, TRUE, PALETTE_NITE, FISHGROUP_NONE

MapGroup_SecertBase:
	map RockBase, TILESET_SECRET_BASE, INDOOR, LANDMARK_ROUTE_47, MUSIC_LAKE_OF_RAGE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BushBase, TILESET_SECRET_BASE, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	
MapGroup_JohtoSafari:
	map JohtoSafariGate, TILESET_GAME_CORNER, INDOOR, LANDMARK_CIANWOOD_CITY, MUSIC_VIRIDIAN_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map JohtoSafariNormal, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map JohtoSafariGrass, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map JohtoSafariFire, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map JohtoSafariWater, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map JohtoSafariBug, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map JohtoSafariFlying, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map JohtoSafariPoison, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map JohtoSafariFighting, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map JohtoSafariElectric, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map JohtoSafariRock, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map JohtoSafariGround, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map JohtoSafariPsychic, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map JohtoSafariIce, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map JohtoSafariDragon, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map JohtoSafariGhostSteel, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map JohtoSafariDark, TILESET_JOHTO_SAFARI, GATE, LANDMARK_CIANWOOD_CITY, MUSIC_POKEMON_MARCH, TRUE, PALETTE_AUTO, FISHGROUP_POND
