...
NidokingEvosAttacks:                 ;final
	db 0 ; no more evolutions
	dbw 1, POWERUPPUNCH
	dbw 1, HORN_DRILL     ;evolution move
	dbw 1, PECK
	dbw 1, LEER
	dbw 4, POISON_STING
	dbw 9, LASER_FOCUS
...
ClefableEvosAttacks:                 ;final
	db 0 ; no more evolutions
	dbw 1, MYSTICALFIRE
	dbw 1, HEAL_BELL      ;evolution move
	dbw 1, POUND
	dbw 1, DEFENSE_CURL
	dbw 4, ENCORE
	dbw 10, SING
...
CrobatEvosAttacks:                   ;final
	db 0 ; no more evolutions
	dbw 1, X_SCISSOR
	dbw 1, POISON_JAB    ;evolution move
	dbw 1, LEECH_LIFE
	dbw 1, SUPERSONIC
	dbw 4, BITE
	dbw 9, SCREECH
...
VileplumeEvosAttacks:                ;final
	db 0 ; no more evolutions
	dbw 1, SLAM
	dbw 1, SLUDGE_BOMB    ;evolution move
	dbw 1, MEGA_DRAIN
	dbw 1, GROWTH
	dbw 4, SWEET_SCENT
	dbw 9, EFFECT_SPORE
...
AnnihilapeEvosAttacks:               ;final
	db 0 ; no more evolutions
	dbw 1, SKY_UPPERCUT
	dbw 1, SHADOWSTRIKE   ;evolution move
	dbw 1, SCRATCH
	dbw 1, LEER
	dbw 4, LOW_KICK
	dbw 9, HOWL
...
PolitoedEvosAttacks:                 ;final
	db 0 ; no more evolutions
	dbw 1, CALM_MIND
	dbw 1, PERISH_SONG    ;evolution move
	dbw 1, ECHOED_VOICE
	dbw 1, HYPNOSIS
	dbw 4, WATER_GUN
	dbw 8, MUD_SLAP
...
VictreebelEvosAttacks:               ;final
	db 0 ; no more evolutions
	dbw 1, SWORDS_DANCE
	dbw 1, LEAF_BLADE     ;evolution move
	dbw 1, WRAP
	dbw 1, GROWTH
	dbw 4, VINE_WHIP
	dbw 7, SLEEP_POWDER
...
RapidashEvosAttacks:                 ;final
	db 0 ; no more evolutions
	dbw 1, DRILL_RUN
	dbw 1, HORN_ATTACK    ;evolution move
	dbw 1, TACKLE
	dbw 1, GROWL
	dbw 4, EMBER
	dbw 9, TAIL_WHIP
...
HaunterEvosAttacks:                  ;final
	...
	dbw 15, NIGHT_SHADE
	dbw 19, CONFUSE_RAY
	dbw 24, SHADOWSTRIKE  ;evolution move
	dbw 29, DARK_PULSE
	dbw 33, HYPNOSIS
	dbw 36, SHADOW_BALL
	dbw 43, DREAM_EATER
...
KangaskhanEvosAttacks:               ;final
	db 0 ; no more evolutions
	dbw 1, SLAM
	dbw 1, POWERUPPUNCH   ;evolution move
	dbw 1, TACKLE
	dbw 1, LEER
	dbw 4, TAIL_WHIP
	dbw 10, BITE
...
Porygon2EvosAttacks:                 ;final
	db 0 ; no more evolutions
	dbw 1, SAFEGUARD
	dbw 1, CALM_MIND      ;evolution move
	dbw 1, TACKLE
	dbw 1, DISABLE
	dbw 4, THUNDERSHOCK
	dbw 8, DEFENSE_CURL
