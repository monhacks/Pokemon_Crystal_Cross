	...
	; tm/hm learnset
	tmhm SHADOW_RUSH, PAIN_SPLIT, SHADOW_BALL, STEEL_WING, SHADOWSTRIKE, SWIFT, ROOST, LASER_FOCUS, RAIN_DANCE, TWISTER, NIGHT_SHADE, THUNDER_WAVE, SUBSTITUTE, CALM_MIND, LIGHT_SCREEN, REFLECT, MIMIC, CURSE, TOXIC, HIDDEN_POWER, SUNNY_DAY, PROTECT, GIGA_DRAIN, SOLARBEAM, RETURN, PSYCHIC_M, DOUBLE_TEAM, SLEEP_TALK, DREAM_EATER, REST, ATTRACT, THIEF, NIGHTMARE, FLY, FLASH
	; end
