	...
	; tm/hm learnset
	tmhm SHADOW_RUSH, CHARGE_BEAM, ENERGY_BALL, HEAL_BELL, EARTH_POWER, THUNDER_WAVE, SUBSTITUTE, CALM_MIND, AURA_SPHERE, LIGHT_SCREEN, REFLECT, WATER_PULSE, SWIFT, MIMIC, CURSE, TOXIC, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, PROTECT, RAIN_DANCE, GIGA_DRAIN, SOLARBEAM, RETURN, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, SLEEP_TALK, SANDSTORM, DREAM_EATER, REST, NIGHTMARE, FLASH
	; end
