	...
	; tm/hm learnset
	tmhm SHADOW_RUSH, HEAL_BELL, DREAM_EATER, SHADOWSTRIKE, SWIFT, SOLARBEAM, LASER_FOCUS, MIMIC, LIGHT_SCREEN, REFLECT, PAIN_SPLIT, NIGHT_SHADE, SUBSTITUTE, CALM_MIND, HAIL, DARK_PULSE, SHADOW_BALL, HEADBUTT, CURSE, ROAR, TOXIC, HIDDEN_POWER, RAIN_DANCE, HYPER_BEAM, ICY_WIND, PROTECT, IRON_TAIL, RETURN, DIG, DOUBLE_TEAM, SLEEP_TALK, BLIZZARD, REST, ATTRACT, ICE_BEAM
	; end
