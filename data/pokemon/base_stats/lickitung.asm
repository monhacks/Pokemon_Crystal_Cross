	...
	; tm/hm learnset
	tmhm SHADOW_RUSH, SEISMIC_TOSS, DIG, BULLDOZE, SWORDS_DANCE, MIMIC, SUBMISSION, WAVE_CRASH, SOLARBEAM, COUNTER, MEGA_KICK, MEGA_PUNCH, SUBSTITUTE, WATER_PULSE, DYNAMICPUNCH, HEADBUTT, CURSE, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, BLIZZARD, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, IRON_TAIL, THUNDER, EARTHQUAKE, RETURN, SHADOW_BALL, DOUBLE_TEAM, ICE_PUNCH, SLEEP_TALK, SANDSTORM, FIRE_BLAST, THUNDERPUNCH, DREAM_EATER, ROCK_SLIDE, REST, ATTRACT, THIEF, FIRE_PUNCH, NIGHTMARE, CUT, SURF, STRENGTH, FLAMETHROWER, THUNDERBOLT, ICE_BEAM
	; end
