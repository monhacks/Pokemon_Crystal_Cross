	...
	; tm/hm learnset
	tmhm BLIZZARD, ICE_BEAM, SHADOW_RUSH, SHADOWSTRIKE, PAIN_SPLIT, THUNDER_WAVE, NIGHT_SHADE, SELFDESTRUCT, MEGA_PUNCH, SUBSTITUTE, WILL_O_WISP, DARK_PULSE, MIMIC, DYNAMICPUNCH, HEADBUTT, CURSE, TOXIC, HIDDEN_POWER, HYPER_BEAM, PROTECT, RAIN_DANCE, GIGA_DRAIN, THUNDER, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, ICE_PUNCH, DREAM_EATER, THIEF, NIGHTMARE, ICY_WIND, FLY
	; end
