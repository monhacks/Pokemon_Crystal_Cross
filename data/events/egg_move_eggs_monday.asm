...
EggMoveEggsMonday:
	...
	; Charmander3
	dw SCRATCH, GROWL, FURY_SWIPES, BITE
	...
	; Weedle2
	dw POISON_STING, STRING_SHOT, MEGAHORN, ACID_SPRAY
	...
	; Kabuto4
	dw SCRATCH, HARDEN, ROCK_THROW, RAPID_SPIN
	...
	; Diglett3
	dw SCRATCH, GROWL, ROCK_THROW, MUD_SHOT
