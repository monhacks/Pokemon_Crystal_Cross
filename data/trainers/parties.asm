...
FalknerGroup:
	...
	dw FEAROW
	db SHARP_BEAK
	dw SHARPEN, DRILL_PECK, DRILL_RUN, ROOST
	dw MALE_DVS
...
Rival1Group:
	...
	db 12
	dw SNEASEL
	dw SHARPEN, QUICK_ATTACK, FURY_CUTTER, PURSUIT
	dw MALE_DVS
	db 14
	dw ZUBAT
	...
	db 16
	dw CROCONAW
	dw BITE, SHARPEN, WATER_GUN, MUD_SLAP
	dw MALE_DVS
	db -1 
...
LtSurgeGroup:
	...
	dw ELECTABUZZ
	db MAGNET
	dw SCREECH, THUNDERPUNCH, BRICK_BREAK, THUNDER
	dw MALE_DVS
...
BugCatcherGroup:
	...
	db 25
	dw BEEDRILL
	dw PURSUIT, SHARPEN, FELL_STINGER, PURSUIT
	db 24
	dw BUTTERFREE
...
HikerGroup:
	...
	db 34
	dw MACHOKE
	dw POWERUPPUNCH, BRICK_BREAK, HEADBUTT, DIG
	db -1 ; end
...
BlackbeltGroup:
	...
	db 38
	dw MACHAMP
	dw HEADBUTT, SWAGGER, THUNDERPUNCH, BRICK_BREAK
	db 33
	dw STEELIX
