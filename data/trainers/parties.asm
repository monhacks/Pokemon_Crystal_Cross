...
FalknerGroup:
	...
	db 7 
	dw SPEAROW     
	db PECK, GROWL, LEER, MUD_SLAP
	dw MALE_DVS
	db 10
	dw PIDGEOTTO
	db TACKLE, MUD_SLAP, GUST, FEATHERDANCE
	dw FEMALE_DVS
	db -1 
	...
	db 50
	dw FEAROW
	db SHARP_BEAK, ROOST, DRILL_PECK, MIRROR_MOVE, STEEL_WING
	dw MALE_DVS
	dw 20K, 50K, 35K, 35K, 10K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw NOCTOWL
	db LUM_BERRY, REFLECT, HYPER_VOICE, RECOVER, PSYCHIC_M
	dw SHINY_F_DVS
	dw 45K,   0, 35K, 25K, 45K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw DODRIO
	db RAWST_BERRY, DRILL_PECK, AGILITY, PURSUIT, THRASH
	dw FEMALE_DVS
	dw 25K, 40K, 20K, 45K, 20K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw HONCHKROW
	db BLACKGLASSES, SKY_ATTACK, THUNDER_WAVE, DARK_PULSE, ICY_WIND
	dw MALE_DVS
	dw 40K, 25K, 25K, 20K, 40K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw XATU
	db TWISTEDSPOON, CONFUSE_RAY, PSYBEAM, CALM_MIND, RAZOR_WIND
	dw MALE_DVS
	dw 30K,   0, 25K, 40K, 55K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw PIDGEOT
	db CHERI_BERRY, RAZOR_WIND, FEATHERDANCE, RETURN, ROOST
	dw FEMALE_DVS
	dw 20K, 25K, 15K, 60K, 30K ; 150k
	;   hp, atk, def, spd, spc
	db -1 
...
WhitneyGroup:
	...
	db 15
	dw SNUBBULL
	db TACKLE, ATTRACT, LICK, CHARM
	dw FEMALE_DVS
	db 17
	dw CLEFAIRY
	db POUND, SING, ENCORE, METRONOME
	dw FEMALE_DVS
	db 18
	dw TEDDIURSA ;hold item everstone
	db FURY_SWIPES, LICK, CHARM, SWEET_SCENT
	dw FEMALE_DVS
	db 20
	dw MILTANK
	...
	db 50
	dw WIGGLYTUFF
	db BRIGHTPOWDER, SING, SLAM, ICE_BEAM, THUNDER_WAVE
	dw FEMALE_DVS
	dw 45K, 35K, 20K, 25K, 25K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw GRANBULL
	db QUICK_CLAW, CRUNCH, TAKE_DOWN, SWAGGER, DYNAMICPUNCH
	dw FEMALE_DVS
	dw 30K, 50K, 20K, 30K, 20K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw CLEFABLE
	db PECHA_BERRY, CALM_MIND, PSYCHIC_M, MOONLIGHT, METRONOME
	dw FEMALE_DVS
	dw 40K, 10K, 40K, 15K, 45K  ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw FURRET
	db FOCUS_BAND, POWERUPPUNCH, SLAM, BATON_PASS, DIG
	dw SHINY_F_DVS
	dw 25K, 35K, 25K, 45K, 20K  ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw SYLVEON
	db POLKADOT_BOW, ATTRACT, HYPER_VOICE, RECOVER, HEAL_BELL
	dw MALE_DVS
	dw 40K,   0, 25K, 40K, 45K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw MILTANK
	db LUM_BERRY, EARTHQUAKE, ATTRACT, SLAM, MILK_DRINK
	dw FEMALE_DVS
...
BugsyGroup:
	...
	db 13
	dw LEDYBA
	db TACKLE, SUPERSONIC, GROWTH, GUST
	dw FEMALE_DVS
	db 15
	dw BUTTERFREE
	db CONFUSION, EFFECT_SPORE, GUST, SLEEP_POWDER
	dw MALE_DVS
	db 16
	dw SCYTHER
	db QUICK_ATTACK, SHARPEN, FURY_CUTTER, PURSUIT
	dw MALE_DVS
	db -1 
	...
	db 50
	dw LEDIAN 
	db BLACKBELT_I, POWERUPPUNCH, LIGHT_SCREEN, BATON_PASS, ICE_PUNCH
	dw FEMALE_DVS
	dw 45K, 30K, 25K, 25K, 35K ; 160k
	;   hp, atk, def, spd, spc
	db 50
	dw BUTTERFREE
	db SILVERPOWDER, PSYBEAM, SAFEGUARD, EFFECT_SPORE, SILVER_WIND
	dw MALE_DVS
	dw 35K,   0, 20K, 40K, 55K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw SCYTHER
	db FOCUS_BAND, SWORDS_DANCE, REVERSAL, FURY_CUTTER, WING_ATTACK
	dw MALE_DVS
	dw 15K, 50K, 20K, 50K, 15K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw YANMEGA
	db SHARP_BEAK, BUG_BUZZ, ANCIENTPOWER, RAZOR_WIND, SHADOW_BALL
	dw MALE_DVS
	dw 35K,   0, 20K, 55K, 40K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw GLISCOR
	db SOFT_SAND, WING_ATTACK, FURY_CUTTER, SCREECH, EARTHQUAKE
	dw MALE_DVS
	dw 25K, 40K, 30K, 35K, 20K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw SCIZOR
	db LEFTOVERS, CURSE, METAL_CLAW, X_SCISSOR, SLASH
	dw FEMALE_DVS
	dw 35K, 50K, 30K, 15K, 20K ; 150k
	;   hp, atk, def, spd, spc
	db -1 
...
MortyGroup:
	...
	db 21
	dw MISDREAVUS
	db CONFUSION, MEAN_LOOK, SPITE, CONFUSE_RAY
	dw FEMALE_DVS
	db 23
	dw CUBONE
	db SCREECH, BONE_CLUB, ENDURE, PERISH_SONG
	dw MALE_DVS
	db 25
	dw HAUNTER
	...
	db 23
	dw NINETALES
	db CURSE, SHADOW_BALL, SPITE, FLAMETHROWER
	dw SHINY_M_DVS
	db -1 
	...
	db 50
	dw HAUNTER
	db FOCUS_BAND, HYPNOSIS, MEAN_LOOK, SHADOW_BALL, DREAM_EATER
	dw MALE_DVS
	dw 30K,   0, 20K, 55K, 55K ; 160k
	;   hp, atk, def, spd, spc
	db 50
	dw NINETALES_ALOLAN
	db NEVERMELTICE, CONFUSE_RAY, ICY_WIND, SHADOW_BALL, DESTINY_BOND
	dw FEMALE_DVS
	dw 25K,   0, 20K, 55K, 50K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw MAROWAK_ALOLAN
	db THICK_CLUB, SHADOW_PUNCH, FLAME_WHEEL, BONEMERANG, PAIN_SPLIT
	dw MALE_DVS
	dw 20K, 55K, 35K, 20K, 20K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw MISMAGIUS
	db BRIGHTPOWDER, POWER_GEM, MEAN_LOOK, SHADOW_BALL, PERISH_SONG
	dw FEMALE_DVS
	dw 15K,   0, 25K, 55K, 55K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw TYPHLOSION_HISUIAN
	db CHARCOAL, HEX, WILL_O_WISP, FLAMETHROWER, CALM_MIND
	dw MALE_DVS
	dw 25K,   0, 20K, 55K, 50K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw GENGAR
	db SPELL_TAG, THUNDERBOLT, SHADOW_BALL, DESTINY_BOND, SLUDGE_BOMB
	dw FEMALE_DVS
	...
	db 50
	dw NINETALES
	db CHARCOAL, HEX, WILL_O_WISP, FLAMETHROWER, CURSE
	dw SHINY_M_DVS
...
PryceGroup:
	...
	db 25
	dw DELIBIRD
	db SPIKES, PRESENT, POWDER_SNOW, ENCORE
	dw MALE_DVS
	db 27
	dw SEEL
	db HEADBUTT, ICY_WIND, WATER_PULSE, HAIL
	dw MALE_DVS
	db 29
	dw DEWGONG
	db HEADBUTT, SLEEP_TALK, BLIZZARD, REST
	dw FEMALE_DVS
	db 31
	dw PILOSWINE
	db ICE_SHARD, HORN_ATTACK, MIST, BULLDOZE
	dw MALE_DVS
	db -1 
	...
	db 50
	dw GLACEON
	db NEVERMELTICE, HAIL, REFLECT, BLIZZARD, MIRROR_COAT
	dw FEMALE_DVS
	dw 40K,   0, 20K, 35K, 55K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw DEWGONG
	db CHESTO_BERRY, WATER_PULSE, SLEEP_TALK, BLIZZARD, REST
	dw FEMALE_DVS
	dw 50K,   0, 35K, 30K, 35K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw CLOYSTER
	db MYSTIC_WATER, ICE_SHARD, SPIKES, SPIKE_CANNON, RAZOR_SHELL
	dw MALE_DVS
	dw 25K, 40K, 45K, 25K, 15K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw SANDSLASH_ALOLAN
	db QUICK_CLAW, HAIL, ICE_PUNCH, METAL_CLAW, SWORDS_DANCE
	dw MALE_DVS
	dw 20K, 45K, 20K, 50K, 15K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw LAPRAS
	db LEFTOVERS, PSYCHIC_M, RECOVER, PERISH_SONG, WHIRLPOOL
	dw FEMALE_DVS
	dw 45K,   0, 30K, 25K, 50K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw PILOSWINE
	db SOFT_SAND, ICICLE_CRASH, HOWL, ROCK_SLIDE, EARTHQUAKE
	dw MALE_DVS
...
JasmineGroup:
	...
	db 27
	dw MAGNEMITE
	db CHARGE_BEAM, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	dw MALE_DVS
	db 30
	dw QWILFISH
	db SPIKES, IRON_TAIL, PIN_MISSILE, WATER_GUN
	dw MALE_DVS
	db 32
	dw SKARMORY
	db PECK, SAND_ATTACK, AGILITY, STEEL_WING
	dw FEMALE_DVS
	db 35
	dw STEELIX
	...
	db 50
	dw MAGNETON
	db METAL_COAT, THUNDER, SUPERSONIC, RAIN_DANCE, FLASH_CANNON
	dw MALE_DVS
	dw 30K,   0, 35K, 40K, 45K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw FORRETRESS
	db LEFTOVERS, PROTECT, PAIN_SPLIT, TOXIC, SELFDESTRUCT
	dw FEMALE_DVS
	dw 40K, 10K, 50K,   0, 50K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw DETOQWIL
	db QUICK_CLAW, SWORDS_DANCE, WATERFALL, IRON_TAIL, SELFDESTRUCT
	dw MALE_DVS
	dw 20K, 55K, 30K, 20K, 25K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw SKARMORY
	db SHARP_BEAK, ROOST, DRILL_PECK, SPIKES, STEEL_WING
	dw FEMALE_DVS
	dw 40K, 20K, 60K, 10K, 20K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw MAGNETON
	db MAGNET, THUNDERBOLT, THUNDER_WAVE, TRI_ATTACK, FLASH_CANNON
	dw SHINY_M_DVS
	dw 25K,   0, 25K, 50K, 50K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw STEELIX
	db SOFT_SAND, SCREECH, ROCK_SLIDE, EARTHQUAKE, IRON_TAIL
	dw MALE_DVS
...
ChuckGroup:
	...
	db 28
	dw TYROGUE
	db TACKLE, JUMP_KICK, NO_MOVE, NO_MOVE
	dw MALE_DVS
	db 25
	dw FARFETCH_D
	db SWORDS_DANCE, FURY_CUTTER, ROCK_SMASH, PECK
	dw FEMALE_DVS
	db 27
	dw PRIMEAPE
	db LOW_KICK, PURSUIT, ROCK_SLIDE, FURY_SWIPES
	dw MALE_DVS
	db 30
	dw POLIWRATH
	db HYPNOSIS, MUD_SHOT, SURF, DYNAMICPUNCH
	dw MALE_DVS
	db -1 
	...
	db 50
	dw HITMONTOP
	db BLACKBELT_I, RAPID_SPIN, PURSUIT, JUMP_KICK, COUNTER
	dw MALE_DVS
	dw 15K, 40K, 20K, 60K, 15K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw PRIMEAPE
	db KINGS_ROCK, ROCK_SLIDE, ROCK_SLIDE, CROSS_CHOP, MEGA_KICK
	dw MALE_DVS
	dw 30K, 35K, 45K, 20K, 20K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw WU_DUK
	db STICK, SWORDS_DANCE, WING_ATTACK, LEAF_BLADE, CROSS_CHOP
	dw FEMALE_DVS
	dw 15K, 40K, 20K, 40K, 35K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw MACHOKE
	db QUICK_CLAW, POWERUPPUNCH, SUBMISSION, ROCK_SLIDE, DYNAMICPUNCH
	dw FEMALE_DVS
	dw 20K, 55K, 40K, 15K, 20K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw HERACROSS
	db SILVERPOWDER, MEGAHORN, ENDURE, REVERSAL, METAL_CLAW
	dw MALE_DVS
	dw 25K, 40K, 30K, 30K, 25K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw POLIWRATH
	db MYSTIC_WATER, HYPNOSIS, MUD_SHOT, HYDRO_PUMP, DYNAMICPUNCH
	dw MALE_DVS
...
ClairGroup:
	...
	db 35
	dw CHARMELEON
	db FLAMETHROWER, METAL_CLAW, SCARY_FACE, DRAGON_CLAW
	dw FEMALE_DVS
	db 37
	dw DRAGONAIR
	...
	db 37
	dw DRAGONAIR
	db THUNDER_WAVE, ICE_BEAM, SAFEGUARD, DRAGONBREATH
	dw MALE_DVS
	db 40
	dw KINGDRA
	db SMOKESCREEN, BUBBLEBEAM, HYPER_BEAM, DRAGONBREATH
	dw FEMALE_DVS
	db -1 
	...
	db 50
	dw DRAGONAIR
	db NEVERMELTICE, THUNDER_WAVE, ICE_BEAM, SAFEGUARD, DRAGONBREATH
	dw MALE_DVS
	dw 35K,   0, 20K, 50K, 45K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw AMPHAROS
	db MAGNET, POWER_GEM, THUNDERBOLT, LIGHT_SCREEN, DRAGONBREATH
	dw MALE_DVS
	dw 35K,   0, 30K, 25K, 60K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw MEGANIUM
	db LEFTOVERS, GROWTH, PETAL_DANCE, MORNING_SUN, DRAGONBREATH
	dw FEMALE_DVS
	dw 40K, 25K, 30K, 20K, 35K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw DUSERPENT
	db KINGS_ROCK, GLARE, FLAMETHROWER, ROOST, TWISTER
	dw MALE_DVS
	dw 50K,   0, 25K, 40K, 35K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw DRAGONAIR
	db PERSIM_BERRY, DRAGON_DANCE, THUNDERBOLT, EXTREMESPEED, OUTPURSUIT
	dw FEMALE_DVS
	dw 20K, 50K, 20K, 45K, 15K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw KINGDRA
	db SCOPE_LENS, OCTAZOOKA, ICE_BEAM, HYPER_BEAM, DRAGONBREATH
	dw FEMALE_DVS
...
Rival1Group:
	...
	db 12
	dw SNEASEL
	db LEER, ICY_WIND, QUICK_ATTACK, FURY_CUTTER
	dw MALE_DVS
	db 14
	dw ZUBAT
	db BITE, SUPERSONIC, POISON_FANG, MEGA_DRAIN
	dw MALE_DVS
	db 16
	dw BAYLEEF
	db RAZOR_LEAF, SLEEP_POWDER, REFLECT, SLAM
	dw FEMALE_DVS
	db -1 
	...
	db 16
	dw QUILAVA
	db EMBER, LEER, SMOKESCREEN, QUICK_ATTACK
	dw MALE_DVS
	db -1 
	...
	db 16
	dw CROCONAW
	db BITE, LEER, WATER_GUN, PURSUIT
	dw MALE_DVS
	db -1 
	...
	db 18
	dw GASTLY
	db SMOG, CURSE, CONFUSE_RAY, NIGHT_SHADE
	dw FEMALE_DVS
	db 20
	dw SNEASEL
	db LEER, ICE_PUNCH, QUICK_ATTACK, FURY_CUTTER
	dw MALE_DVS
	db 20
	dw ZUBAT
	db BITE, SUPERSONIC, POISON_FANG, MEGA_DRAIN
	...
	db 24
	dw BAYLEEF
	db MEGA_DRAIN, SLEEP_POWDER, REFLECT, SLAM
	dw FEMALE_DVS
	db -1 
	...
	db 24
	dw QUILAVA
	db FLAME_WHEEL, LEER, SMOKESCREEN, QUICK_ATTACK
	dw MALE_DVS
	db -1 
	...
	db 24
	dw CROCONAW
	db BITE, LEER, WATER_GUN, ICE_FANG
	dw MALE_DVS
	db -1 
	...
	db 30
	dw GOLBAT
	db POISON_FANG, BITE, CONFUSE_RAY, WING_ATTACK
	dw MALE_DVS
	db 28
	dw MAGNEMITE
	db SWIFT, CHARGE_BEAM, SONICBOOM, THUNDER_WAVE
	dw MALE_DVS
	db 30
	dw HAUNTER
	db HYPNOSIS, CURSE, CONFUSE_RAY, SHADOW_PUNCH
	dw FEMALE_DVS
	db 32
	dw SNEASEL
	db PURSUIT, ICE_PUNCH, AGILITY, FURY_CUTTER
	dw MALE_DVS
	db 36
	dw MEGANIUM
	db PETAL_DANCE, GROWTH, LIGHT_SCREEN, SLAM
	dw FEMALE_DVS
	db -1 
	...
	db 36
	dw TYPHLOSION
	db FLAME_WHEEL, WILL_O_WISP, SWIFT, THUNDERPUNCH
	dw MALE_DVS
	db -1 
	...
	db 36
	dw FERALIGATR
	db SURF, ICE_FANG, SCARY_FACE, SLASH
	dw MALE_DVS
	db -1 
	...
	db 34
	dw WEAVILE
	db PURSUIT, ICE_PUNCH, AGILITY, METAL_CLAW
	dw MALE_DVS
	db 36
	dw GOLBAT
	db POISON_FANG, BITE, CONFUSE_RAY, WING_ATTACK
	...
	db 35
	dw MAGNETON
	db CHARGE_BEAM, SWIFT, THUNDER_WAVE, FLASH_CANNON
	dw MALE_DVS
	db 35
	dw HAUNTER
	db MEAN_LOOK, CURSE, CONFUSE_RAY, SHADOW_BALL
	dw FEMALE_DVS
	db 34
	dw SEADRA
	db TWISTER, AGILITY, SURF, BLIZZARD
	dw MALE_DVS
	db 38
	dw MEGANIUM
	db PETAL_DANCE, GROWTH, LIGHT_SCREEN, SLAM
	...
	db 38
	dw TYPHLOSION
	db FLAMETHROWER, WILL_O_WISP, THUNDERPUNCH, SWIFT
	dw MALE_DVS
	db -1 
	...
	db 38
	dw FERALIGATR
	db WATERFALL, ICE_FANG, SCARY_FACE, SLASH
	dw MALE_DVS
	db -1 
...
WillGroup:
	...
	db 50
	dw XATU
	db SHARP_BEAK, AGILITY, RAZOR_WIND, CONFUSE_RAY, PSYCHIC_M
	dw FEMALE_DVS
	dw 40K,   0, 30K, 40K, 55K ; 165k
	;   hp, atk, def, spd, spc
	db 50
	dw WYRDEER
	db TWISTEDSPOON, THUNDER_WAVE, MIRROR_COAT, JUMP_KICK, PSYCHO_CUT
	dw MALE_DVS
	dw 25K, 45K, 20K, 40K, 35K ; 165k
	;   hp, atk, def, spd, spc
	db 50
	dw EXEGGUTOR
	db SCOPE_LENS, REFLECT, LEECH_SEED, RAZOR_LEAF, PSYCHIC_M
	dw MALE_DVS
	dw 35K, 30K, 35K, 20K, 45K ; 165k
	;   hp, atk, def, spd, spc
	db 50
	dw SLOWKING
	db LEFTOVERS, WATER_PULSE, AMNESIA, RECOVER, PSYCHIC_M
	dw MALE_DVS
	dw 50K,   0, 50K, 20K, 45K ; 165k
	;   hp, atk, def, spd, spc
	db 50
	dw ESPEON
	db PECHA_BERRY, CALM_MIND, SHADOW_BALL, MORNING_SUN, PSYBEAM
	dw FEMALE_DVS
	dw 30K,   0, 30K, 50K, 55K ; 165k
	;   hp, atk, def, spd, spc
	db 55
	dw ARTICUNO_GALARIAN
	db NEVERMELTICE, HYPNOSIS, ICE_BEAM, RECOVER, PSYCHIC_M
	dw MALE_DVS
...
KogaGroup:
	...
	db 50
	dw ARIADOS
	db QUICK_CLAW, TOXIC, MEGAHORN, POISON_JAB, DOUBLE_TEAM
	dw MALE_DVS
	dw 20K, 55K, 30K, 45K, 30K ; 180k
	;   hp, atk, def, spd, spc
	db 50
	dw VICTREEBEL
	db MIRACLE_SEED, EFFECT_SPORE, LEECH_SEED, SLUDGE_BOMB, LEAF_BLADE
	dw FEMALE_DVS
	dw 30K, 40K, 40K, 20K, 40K ; 170k
	;   hp, atk, def, spd, spc
	db 50
	dw SCIZOR
	db SMOKE_BALL, DOUBLE_TEAM, X_SCISSOR, STEEL_WING, TOXIC
	dw MALE_DVS
	dw 20K, 40K, 25K, 65K, 20K ; 170k
	;   hp, atk, def, spd, spc
	db 50
	dw QWILFISH
	db POISON_BARB, SPIKES, DOUBLE_TEAM, SLUDGE_BOMB, SELFDESTRUCT
	dw MALE_DVS
	dw 60K, 40K, 40K, 20K, 30K ; 190k
	;   hp, atk, def, spd, spc
	db 50
	dw VENOMOTH
	db BRIGHTPOWDER, HYPNOSIS, SILVER_WIND, PSYCHIC_M, GIGA_DRAIN
	dw FEMALE_DVS
	dw 40K,   0, 25K, 45K, 60K ; 170k
	;   hp, atk, def, spd, spc
	db 55
	dw CROBAT
	db KINGS_ROCK, DOUBLE_TEAM, LEECH_LIFE, POISON_FANG, CONFUSE_RAY
	dw MALE_DVS
	...
	db 65
	dw VICTREEBEL
	db MIRACLE_SEED, EFFECT_SPORE, LEECH_SEED, SLUDGE_BOMB, GIGA_DRAIN
	dw FEMALE_DVS
...
BrunoGroup:
	...
	db 50
	dw ONIX
	db SOFT_SAND, DRAGON_DANCE, EARTHQUAKE, SLAM, ROCK_SLIDE
	dw MALE_DVS
	dw 40K, 45K, 40K, 40K, 30K ; 195k
	;   hp, atk, def, spd, spc
	db 50
	dw HITMONLEE
	db KINGS_ROCK, SWAGGER, MEGA_KICK, JUMP_KICK, LASER_FOCUS
	dw MALE_DVS
	dw 20K, 45K, 45K, 30K, 35K ; 175k
	;   hp, atk, def, spd, spc
	db 50
	dw HITMONCHAN
	db RAWST_BERRY, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, POWERUPPUNCH
	dw MALE_DVS
	dw 20K, 45K, 25K, 45K, 40K ; 175k
	;   hp, atk, def, spd, spc
	db 50
	dw RHYDON
	db HARD_STONE, COUNTER, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	dw MALE_DVS
	dw 60K, 45K, 25K, 20K, 25K ; 175k
	;   hp, atk, def, spd, spc
	db 50
	dw PRIMEAPE
	db POLKADOT_BOW, SUBMISSION, POWERUPPUNCH, SCREECH, THRASH
	dw MALE_DVS
	dw 40K, 40K, 30K, 35K, 30K ; 175k
	;   hp, atk, def, spd, spc
	db 55
	dw MACHAMP
	db BLACKBELT_I, ROCK_SLIDE, ENDURE, POWERUPPUNCH, DYNAMICPUNCH
	dw MALE_DVS
...
KarenGroup:
	...
	db 50
	dw UMBREON
	db LUM_BERRY, MOONLIGHT, CONFUSE_RAY, FAINT_ATTACK, CURSE
	dw MALE_DVS
	dw 50K, 25K, 30K, 35K, 40K ; 180k
	;   hp, atk, def, spd, spc
	db 50
	dw VILEPLUME
	db LEFTOVERS, TOXIC, SLUDGE_BOMB, MOONLIGHT, GIGA_DRAIN
	dw SHINY_F_DVS
	dw 45K,   0, 35K, 40K, 60K ; 180k
	;   hp, atk, def, spd, spc
	db 50
	dw HOUNDOOM
	db CHARCOAL, HEX, WILL_O_WISP, FLAMETHROWER, DARK_PULSE
	dw MALE_DVS
	dw 45K,   0, 35K, 50K, 50K ; 180k
	;   hp, atk, def, spd, spc
	db 50
	dw ARBOK_DARK
	db POISON_BARB, GLARE, POISON_JAB, CRUNCH, EARTHQUAKE
	dw MALE_DVS
	dw 40K, 50K, 35K, 40K, 25K ; 190k
	;   hp, atk, def, spd, spc
	db 50
	dw HONCHKROW
	db NO_ITEM, SKY_ATTACK, SWAGGER, THIEF, DARK_PULSE
	dw MALE_DVS
	dw 35K, 45K, 30K, 30K, 40K ; 180k
	;   hp, atk, def, spd, spc
	db 55
	dw TYRANITAR
	db BLACKGLASSES, CRUNCH, ROCK_SLIDE, DRAGON_DANCE, SHADOW_RUSH
	dw FEMALE_DVS
...
ChampionGroup:
	...
	db 50
	dw GYARADOS
	db DRAGON_FANG, RAIN_DANCE, WATERFALL, OUTPURSUIT, HYPER_BEAM
	dw FEMALE_DVS
	dw 30K, 40K, 25K, 50K, 40K ; 185k
	;   hp, atk, def, spd, spc
	db 55
	dw DRAGONITE
	db KINGS_ROCK, THUNDER_WAVE, TWISTER, THUNDER, HYPER_BEAM
	dw MALE_DVS
	dw 45K, 20K, 45K, 35K, 40K ; 185k
	;   hp, atk, def, spd, spc
	db 50
	dw AERODACTYL
	db FOCUS_BAND, WING_ATTACK, DRAGON_CLAW, ROCK_SLIDE, HYPER_BEAM
	dw SHINY_M_DVS
	dw 20K, 45K, 40K, 60K, 20K ; 185k
	;   hp, atk, def, spd, spc
	db 55
	dw DRAGONITE
	db NEVERMELTICE, SAFEGUARD, DRAGON_CLAW, ICE_BEAM, HYPER_BEAM
	dw FEMALE_DVS
	dw 55K, 25K, 25K, 30K, 50K ; 185k
	;   hp, atk, def, spd, spc
	db 50
	dw CHARIZARD
	db CHARCOAL, SUNNY_DAY, DRAGONBREATH, FLAMETHROWER, HYPER_BEAM
	dw MALE_DVS
	dw 30K, 20K, 35K, 55K, 45K ; 185k
	;   hp, atk, def, spd, spc
	db 55
	dw DRAGONITE
	db PERSIM_BERRY, FIRE_PUNCH, EXTREMESPEED, OUTPURSUIT, HYPER_BEAM
	dw MALE_DVS
	...
	db 65
	dw CHARIZARD
	db CHARCOAL, SUNNY_DAY, DRAGONBREATH, SACRED_FIRE, HYPER_BEAM
	dw MALE_DVS
...
BrockGroup:
	...
	db 50
	dw RHYHORN
	db QUICK_CLAW, SWORDS_DANCE, TAKE_DOWN, ROCK_SLIDE, MEGAHORN
	dw FEMALE_DVS
	dw 35K, 40K, 25K, 45K, 15K ; 160k
	;   hp, atk, def, spd, spc
	db 50
	dw GOLEM
	db SOFT_SAND, SANDSTORM, BULLDOZE, SELFDESTRUCT, EARTHQUAKE
	dw MALE_DVS
	dw 30K, 40K, 30K, 20K, 30K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw OMASTAR
	db NEVERMELTICE, ANCIENTPOWER, SURF, ICE_BEAM, HAZE
	dw MALE_DVS
	dw 30K,   0, 60K, 10K, 50K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw GOLBAT
	db LEFTOVERS, TOXIC, PROTECT, LEECH_LIFE, POISON_FANG
	dw MALE_DVS
	dw 40K, 35K, 40K, 20K, 15K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw KABUTOPS
	db MYSTIC_WATER, RAZOR_SHELL, ROCK_SLIDE, ENDURE, FLAIL
	dw MALE_DVS
	dw 15K, 60K, 15K, 50K, 10K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw ONIX
	db HARD_STONE, SCREECH, SLAM, ROCK_SLIDE, EARTHQUAKE
	dw MALE_DVS
...
MistyGroup:
	...
	db 50
	dw SEAKING
	db MYSTIC_WATER, AGILITY, MEGAHORN, WATERFALL, HORN_DRILL
	dw FEMALE_DVS
	dw 20K, 50K, 25K, 45K, 10K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw GOLDUCK
	db TWISTEDSPOON, SURF, CALM_MIND, MUD_SHOT, PSYCHIC_M
	dw MALE_DVS
	dw 30K,   0, 30K, 45K, 45K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw VAPOREON
	db PECHA_BERRY, ICE_BEAM, WATER_PULSE, RAIN_DANCE, RECOVER
	dw FEMALE_DVS
	dw 55K,   0, 30K, 20K, 45K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw LAPRAS
	db NEVERMELTICE, CONFUSE_RAY, THUNDERBOLT, BLIZZARD, SURF
	dw MALE_DVS
	dw 45K,   0, 30K, 20K, 55K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw SEADRA
	db KINGS_ROCK, AGILITY, OCTAZOOKA, TWISTER, ICE_BEAM
	dw FEMALE_DVS
	dw 25K,   0, 35K, 40K, 50K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw STARMIE
	db LEFTOVERS, SURF, CONFUSE_RAY, RECOVER, PSYCHIC_M
	dw MALE_DVS
...
LtSurgeGroup:
	...
	db 50
	dw ELECTRODE
	db POLKADOT_BOW, LIGHT_SCREEN, THUNDERBOLT, SWIFT, SELFDESTRUCT
	dw MALE_DVS
	dw 15K, 35K, 20K, 55K, 25K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw PIKACHU
	db LIGHT_BALL, RAIN_DANCE, THUNDER, DOUBLE_TEAM, SURF
	dw FEMALE_DVS
	dw 35K,   0, 25K, 45K, 45K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw MAGNETON
	db METAL_COAT, LASER_FOCUS, HIDDEN_POWER, FLASH_CANNON, ZAP_CANNON
	dw MALE_DVS
	dw 20K,   0, 35K, 35K, 60K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw JOLTEON
	db BRIGHTPOWDER, THUNDER_WAVE, AURA_SPHERE, THUNDERBOLT, EXTREMESPEED
	dw MALE_DVS
	dw 20K,   0, 20K, 60K, 50K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw ELECTABUZZ
	db MAGNET, SCREECH, THUNDERPUNCH, CROSS_CHOP, THUNDER
	dw MALE_DVS
	dw 20K, 45K, 25K, 20K, 40K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw RAICHU
	db KINGS_ROCK, VOLT_TACKLE, JUMP_KICK, AGILITY, SLAM
	dw MALE_DVS
...
ScientistGroup:
	...
	db 30
	dw PORYGON
	db PSYBEAM, CONVERSION2, RECOVER, TRI_ATTACK
	db -1 
...
ErikaGroup:
	...
	db 50
	dw TANGELA
	db HARD_STONE, EFFECT_SPORE, ANCIENTPOWER, GIGA_DRAIN, AMNESIA
	dw FEMALE_DVS
	dw 45K,   0, 40K, 25K, 40K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw BELLOSSOM
	db FOCUS_BAND, SUNNY_DAY, MOONLIGHT, SOLARBEAM, HIDDEN_POWER ;fire
	dw F_HP_FIRE
	dw 20K,   0, 20K, 60K, 50K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw LEAFEON
	db PINK_BOW, GROWTH, LEAF_BLADE, AURA_SPHERE, TAKE_DOWN
	dw MALE_DVS
	dw 25K, 40K, 30K, 30K, 25K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw VICTREEBEL
	db LEFTOVERS, SUNNY_DAY, PROTECT, GIGA_DRAIN, TOXIC
	dw FEMALE_DVS
	dw 35K,   0, 35K, 45K, 35K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw VENUSAUR
	db PERSIM_BERRY, MORNING_SUN, EARTHQUAKE, PETAL_DANCE, SLUDGE_BOMB
	dw FEMALE_DVS
	dw 25K, 40K, 25K, 20K, 40K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw VILEPLUME
	db MIRACLE_SEED, GROWTH, SPORE, GIGA_DRAIN, SLUDGE_BOMB
	dw FEMALE_DVS
	dw 25K,   0, 25K, 50K, 50K ; 150k
	;   hp, atk, def, spd, spc
	db -1 
...
SchoolboyGroup:
	...
	db 37
	dw VILEPLUME
	db SOLARBEAM, SLEEP_POWDER, SLUDGE, MOONLIGHT
	db -1 ; end
	...
	db 35
	dw XATU      
	db PECK, NIGHT_SHADE, SWIFT, CONFUSION
	db 32
	dw SUNFLORA   
	db SUNNY_DAY, PETAL_DANCE, GROWTH, MEGA_DRAIN
	db 32
	dw YANMA    
	...
	db 34
	dw HYPNO
	db PSYCHIC_M, LIGHT_SCREEN, REFLECT, SMOG
	db 38
	dw MAGNETON
	db ZAP_CANNON, THUNDER_WAVE, LASER_FOCUS, SWIFT
	db -1 
...
BirdKeeperGroup:
	...
	db 40
	dw FARFETCH_D
	db LEAF_BLADE, PROTECT, FLY, SLASH
	db -1 ; end
...
LassGroup:
	...
	db 29
	dw AMPHAROS
	db TACKLE, THUNDERSHOCK, THUNDER_WAVE, FIRE_PUNCH
	db -1 ; end
	...
	db 32
	dw AMPHAROS
	db TACKLE, THUNDERPUNCH, THUNDER_WAVE, FIRE_PUNCH
	db -1 ; end
	...
	db 36
	dw AMPHAROS
	db SWIFT, THUNDERPUNCH, THUNDER_WAVE, FIRE_PUNCH
	db 36
	dw GOLDUCK
...
JanineGroup:
	...
	db 50
	dw GLOOM
	db POISON_BARB, SPORE, SLUDGE, GIGA_DRAIN, MOONLIGHT
	dw MALE_DVS
	dw 45K,   0, 35K, 30K, 50K ; 160k
	;   hp, atk, def, spd, spc
	db 50
	dw WEEZING
	db CHARCOAL, SMOKESCREEN, SLUDGE_BOMB, TOXIC, FLAMETHROWER
	dw MALE_DVS
	dw 40K,   0, 45K, 20K, 45K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw GOLBAT
	db BRIGHTPOWDER, DOUBLE_TEAM, POISON_FANG, CONFUSE_RAY, RAZOR_WIND
	dw FEMALE_DVS
	dw 15K, 35K, 15K, 55K, 30K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw MUK
	db LEFTOVERS, SLUDGE_BOMB, ACID_ARMOR, DISABLE, FAINT_ATTACK
	dw MALE_DVS
	dw 35K, 35K, 30K, 10K, 40K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw ARBOK
	db KINGS_ROCK, GLARE, POISON_JAB, ATTRACT, CRUNCH
	dw FEMALE_DVS
	dw 30K, 50K, 25K, 25K, 20K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw VENOMOTH
	db SILVERPOWDER, SILVER_WIND, DOUBLE_TEAM, SLUDGE, PSYCHIC_M ;acid spray
	dw MALE_DVS
	dw 20K,   0, 20K, 50K, 60K ; 150k
	;   hp, atk, def, spd, spc
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 26
	dw CHARMANDER
	db EMBER, SMOKESCREEN, METAL_CLAW, SCARY_FACE
	db 26
	dw SQUIRTLE
	db HARDEN, WATER_GUN, BITE, CURSE
	db 26
	dw BULBASAUR
	db LEECH_SEED, EFFECT_SPORE, SLEEP_POWDER, RAZOR_LEAF
	db -1 ; end
	...
	db 35
	dw VICTREEBEL
	db WRAP, TOXIC, SLUDGE, RAZOR_LEAF
	db 35
	dw KINGLER
	db BUBBLEBEAM, STOMP, X_SCISSOR, PROTECT
	db 35
	dw FLAREON
	...
	db 39
	dw KINGLER
	db KINGS_ROCK, SURF, STOMP, X_SCISSOR, BLIZZARD
	db 39
	dw FLAREON
	...
	db 37
	dw DRAGONAIR
	db WRAP, SURF, DRAGON_PURSUIT, SLAM
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 25
	dw SKIPLOOM
	db MORNING_SUN, EFFECT_SPORE, MEGA_DRAIN, LEECH_SEED
	db 25
	dw NINETALES
	...
	db 32
	dw BULBASAUR
	db GROWL, LEECH_SEED, EFFECT_SPORE, RAZOR_LEAF
	db 32
	dw IVYSAUR
	db GROWL, LEECH_SEED, EFFECT_SPORE, RAZOR_LEAF
	db 32
	dw VENUSAUR
	db SLAM, SLEEP_POWDER, RAZOR_LEAF, SWEET_SCENT
	db -1 ; end
	...
	db 25
	dw GLOOM
	db MEGA_DRAIN, EFFECT_SPORE, SLUDGE, SOLARBEAM
	db -1 
	...
	db 43
	dw RAPIDASH
	db FOCUS_BAND, STOMP, FIRE_SPIN, HORN_ATTACK, FIRE_BLAST
	db -1 ; end
	...
	db 40
	dw NIDOQUEEN
	db PINK_BOW, EARTHQUAKE, DOUBLE_KICK, TOXIC, SLAM
	db 38
	dw STARMIE
	...
	db 50
	dw TYPHLOSION
	db FLAME_WHEEL, THUNDERPUNCH, FLAMETHROWER, EARTHQUAKE
	dw MALE_DVS
	db "QUIL@"
	db 50
	dw PIDGEOT
	db FLY, STEEL_WING, TAKE_DOWN, ROOST
	dw FEMALE_DVS
	db "MINA@"
	db 50
	dw BUTTERFREE
	db PSYBEAM, SILVER_WIND, MORNING_SUN, GIGA_DRAIN
	dw FEMALE_DVS
	db "WINGS@"
	db 50
	dw VICTREEBEL
	db GROWTH, RAZOR_LEAF, SLUDGE_BOMB, CUT
	dw FEMALE_DVS
	db "BELLA@"
	db 50
	dw QUAGSIRE
	db SURF, REST, SNORE, EARTHQUAKE
	dw FEMALE_DVS
	db "WOOPY@"
	db 50
	dw MACHAMP
	db STRENGTH, DYNAMICPUNCH, ICE_PUNCH, ROCK_SLIDE
	dw FEMALE_DVS
	db "MUSCLE@"
	db -1 ; end
...
BeautyGroup:
	...
	db 17
	dw HOPPIP
	db MORNING_SUN, TAIL_WHIP, TACKLE, EFFECT_SPORE
	db 17
	dw SKIPLOOM
	db MORNING_SUN, TAIL_WHIP, TACKLE, EFFECT_SPORE
	db -1 ; end
...
PokemaniacGroup:
	...
	db 41
	dw CHANSEY
	db ROLLOUT, ATTRACT, TOXIC, SOFTBOILED
	db -1 ; end
...
SabrinaGroup:
	...
	db 50
	dw KADABRA
	db FOCUS_BAND, THUNDER_WAVE, PSYBEAM, SHADOW_BALL, REFLECT
	dw MALE_DVS
	dw 20K,   0, 25K, 60K, 55K ; 160k
	;   hp, atk, def, spd, spc
	db 50
	dw GOLDUCK
	db MYSTIC_WATER, PSYCHO_CUT, SURF, PSYCH_UP, LIGHT_SCREEN
	dw FEMALE_DVS
	dw 35K, 35K, 20K, 25K, 35K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw BUTTERFREE
	db BRIGHTPOWDER, SILVER_WIND, PSYBEAM, SAFEGUARD, MORNING_SUN
	dw FEMALE_DVS
	dw 30K,   0, 25K, 50K, 55K ; 160k
	;   hp, atk, def, spd, spc
	db 50
	dw HAUNTER
	db SPELL_TAG, HYPNOSIS, SHADOW_BALL, DREAM_EATER, DESTINY_BOND
	dw MALE_DVS
	dw 25K,   0, 20K, 65K, 50K ; 160k
	;   hp, atk, def, spd, spc
	db 50
	dw SLOWBRO
	db LEFTOVERS, AMNESIA, WATER_PULSE, RECOVER, PSYCHIC_M
	dw MALE_DVS
	dw 50K,   0, 45K, 10K, 45K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw ALAKAZAM
	db TWISTEDSPOON, CALM_MIND, AURA_SPHERE, PSYCHIC_M, RECOVER
	dw MALE_DVS
...
BugCatcherGroup:
	...
	db 24
	dw BUTTERFREE
	db CONFUSION, EFFECT_SPORE, SUPERSONIC, WHIRLWIND
	db 24
	dw BUTTERFREE
	db CONFUSION, EFFECT_SPORE, SUPERSONIC, WHIRLWIND
	db 25
	dw BEEDRILL
	db PURSUIT, SHARPEN, FELL_STINGER, PURSUIT
	db 24
	dw BUTTERFREE
	...
	db 30
	dw BUTTERFREE
	db CONFUSION, EFFECT_SPORE, SUPERSONIC, GUST
	db 30
	dw BUTTERFREE
	db CONFUSION, EFFECT_SPORE, SUPERSONIC, GUST
	db 32
	dw BEEDRILL
	db PIN_MISSILE, PURSUIT, FELL_STINGER, DOUBLE_TEAM
	db 34
	dw BUTTERFREE
...
FisherGroup:
	...
	db 25
	dw REMORAID
	db LASER_FOCUS, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db 25
	dw REMORAID
	db LASER_FOCUS, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db -1 ; end
	...
	db 34
	dw SEAKING
	db SUPERSONIC, WATERFALL, FLAIL, HORN_ATTACK
	db 34
	dw SEAKING
	db SUPERSONIC, WATERFALL, FLAIL, HORN_ATTACK
	db 38
	...
	db 35
	dw QWILFISH
	db TOXIC, DOUBLE_TEAM, SURF, PIN_MISSILE
	db 39
	dw SEAKING
	db ENDURE, FLAIL, HORN_ATTACK, WATERFALL
	db -1 ; end
	...
	db 34
	dw SEAKING
	db SUPERSONIC, RAIN_DANCE, WATERFALL, HORN_ATTACK
	db 34
	dw SEAKING
	db SUPERSONIC, RAIN_DANCE, WATERFALL, HORN_ATTACK
	db 37
...
SwimmerFGroup:
	...
	db 21
	dw HORSEA
	db LASER_FOCUS, SMOKESCREEN, LEER, WATER_GUN
	db 21
	dw HORSEA
	db DRAGON_PURSUIT, SMOKESCREEN, LEER, WATER_GUN
	db -1 ; end
...
SailorGroup:
	...
	db 18
	dw KRABBY
	db WATER_GUN, LEER, METAL_CLAW, HARDEN
	db 20
	dw KRABBY
	...
	db 38
	dw POLITOED
	db WHIRLPOOL, RAIN_DANCE, SLAM, PERISH_SONG
	db 38
	dw POLIWRATH
...
Rival2Group:
	...
	db 41
	dw WEAVILE
	db ICE_PUNCH, SCREECH, FAINT_ATTACK, SLASH
	dw MALE_DVS
	db 42
	dw GOLBAT
	db POISON_FANG, BITE, CONFUSE_RAY, WING_ATTACK
	...
	db 41
	dw MAGNETON
	db THUNDER, SWIFT, THUNDER_WAVE, FLASH_CANNON
	dw MALE_DVS
	db 43
	dw GENGAR
	db MEAN_LOOK, CURSE, SHADOW_BALL, PSYCHIC_M
	dw FEMALE_DVS
	db 43
	dw SEADRA
	db TWISTER, AGILITY, SURF, BLIZZARD
	...
	db 45
	dw MEGANIUM
	db GIGA_DRAIN, GROWTH, LIGHT_SCREEN, SLAM
	dw FEMALE_DVS
	db -1 ; end
	...
	db 45
	dw TYPHLOSION
	db FLAMETHROWER, WILL_O_WISP, THUNDERPUNCH, TAKE_DOWN
	dw MALE_DVS
	db -1 ; end
	...
	db 45
	dw FERALIGATR
	db HYDRO_PUMP, ICE_FANG, SLASH, SCREECH
	dw MALE_DVS
	db -1 ; end
	...
	db 50
	dw CROBAT
	db POISON_FANG, LEECH_LIFE, CONFUSE_RAY, WING_ATTACK
	dw MALE_DVS
	dw 25K, 40K, 20K, 50K, 15K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw MAGNETON
	db THUNDER, TRI_ATTACK, THUNDER_WAVE, FLASH_CANNON
	dw MALE_DVS
	dw 35K,   0, 30K, 40K, 45K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw GENGAR
	db MEAN_LOOK, DESTINY_BOND, SHADOW_BALL, PSYCHIC_M
	dw FEMALE_DVS
	dw 15K,   0, 25K, 55K, 55K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw KINGDRA
	db DRAGONBREATH, AGILITY, SURF, BLIZZARD
	dw MALE_DVS
	dw 40K,   0, 20K, 30K, 60K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw MEGANIUM
	db GIGA_DRAIN, GROWTH, LIGHT_SCREEN, EARTHQUAKE
	dw FEMALE_DVS
	...
	db 55
	dw TYPHLOSION
	db FIRE_BLAST, WILL_O_WISP, THUNDERPUNCH, TAKE_DOWN
	dw MALE_DVS
	...
	db 55
	dw FERALIGATR
	db HYDRO_PUMP, ICE_FANG, CRUNCH, SCREECH
	dw MALE_DVS
...
HikerGroup:
	...
	db 27
	dw DIGLETT
	db BULLDOZE, DIG, SAND_ATTACK, SLASH
	db 27
	dw DUGTRIO
	db BULLDOZE, DIG, SAND_ATTACK, SLASH
	db -1 ; end
	...
	db 35
	dw DUGTRIO
	db BULLDOZE, DIG, MUD_SLAP, SLASH
	db 38
	dw STEELIX
	...
	db 34
	dw GRAVELER
	db BULLDOZE, SELFDESTRUCT, DEFENSE_CURL, ROLLOUT
	db 36
	dw GOLEM
	db BULLDOZE, SELFDESTRUCT, DEFENSE_CURL, ROLLOUT
	db 34
	dw MACHOKE
	db POWERUPPUNCH, CROSS_CHOP, HEADBUTT, DIG
	db -1 ; end
...
BlaineGroup:
	...
	db 50
	dw CHARMELEON
	db KINGS_ROCK, SUNNY_DAY, DRAGONBREATH, FLAMETHROWER, SWAGGER
	dw FEMALE_DVS
	dw 30K,   0, 40K, 55K, 35K ; 160k
	;   hp, atk, def, spd, spc
	db 50
	dw NINETALES
	db SPELL_TAG, FLAMETHROWER, SHADOW_BALL, DESTINY_BOND, WILL_O_WISP
	dw FEMALE_DVS
	dw 25K,   0, 20K, 50K, 55K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw FLAREON
	db QUICK_CLAW, FLAME_WHEEL, SUBMISSION, SACRED_FIRE, DIG
	dw MALE_DVS
	dw 20K, 60K, 20K, 30K, 20K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw ARCANINE
	db LEFTOVERS, WILL_O_WISP, MORNING_SUN, FLAMETHROWER, CRUNCH
	dw MALE_DVS
	dw 40K, 20K, 35K, 25K, 30K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw RAPIDASH
	db CHARCOAL, SUNNY_DAY, FLAME_WHEEL, SOLARBEAM, LOW_KICK
	dw FEMALE_DVS
	dw 15K, 45K, 15K, 40K, 35K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw MAGMAR
	db MAGNET, FIRE_BLAST, LOW_KICK, THUNDERPUNCH, CONFUSE_RAY
	dw MALE_DVS
...
BlackbeltGroup:
	...
	db 27
	dw HITMONLEE
	db DOUBLE_KICK, ENDURE, JUMP_KICK, TACKLE
	db -1 ; end
	...
	db 33
	dw ONIX
	db WRAP, ROCK_THROW, TOXIC, DIG
	db 38
	dw MACHAMP
	db HEADBUTT, SWAGGER, THUNDERPUNCH, CROSS_CHOP
	db 33
	dw STEELIX
	db EARTHQUAKE, ROCK_THROW, IRON_TAIL, SANDSTORM
	db 36
	dw HITMONLEE
	db DOUBLE_TEAM, JUMP_KICK, MUD_SLAP, SWIFT
	db -1 ; end
	...
	db 27
	dw HITMONCHAN
	db POWERUPPUNCH, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH
	db -1 ; end
	...
	db 25
	dw MACHOP
	db LEER, POUND, POWERUPPUNCH, SEISMIC_TOSS
	db 25
	dw MACHOKE
	db LEER, POWERUPPUNCH, SEISMIC_TOSS, ROCK_SLIDE
	db -1 ; end
...
PsychicGroup:
	...
	db 20
	dw SLOWPOKE
	db CURSE, SLAM, WATER_GUN, CONFUSION
	db -1 ; end
	...
	db 13
	dw ABRA
	db TELEPORT, FLASH, HIDDEN_POWER, NO_MOVE
	db 13
	dw ABRA
	db TELEPORT, FLASH, HIDDEN_POWER, NO_MOVE
	db 15
	dw KADABRA
	db TELEPORT, DISABLE, CONFUSION, NO_MOVE
	db -1 ; end
	...
	db 24
	dw NATU
	db LEER, NIGHT_SHADE, CONFUSION, CONFUSE_RAY
	db 26
	dw KADABRA
	db DISABLE, PSYBEAM, RECOVER, CONFUSION
	db -1 ; end
...
PicnickerGroup:
	...
	db 31
	dw CLEFAIRY
	db ENCORE, SING, POUND, DOUBLE_TEAM
	db -1 ; end
	...
	db 37
	dw CLEFAIRY
	db ENCORE, POUND, DOUBLE_TEAM, METRONOME
	db -1 ; end
	...
	db 30
	dw WEEPINBELL
	db SLEEP_POWDER, VINE_WHIP, EFFECT_SPORE, SLUDGE_BOMB
	db 32
	dw NIDOKING
	db EARTHQUAKE, DOUBLE_KICK, POISON_STING, IRON_TAIL
	db 32
	dw NIDOQUEEN
	db EARTHQUAKE, DOUBLE_KICK, TAIL_WHIP, SLAM
	db -1 ; end
	...
	db 33
	dw JUMPLUFF
	db PROTECT, SUNNY_DAY, LEECH_SEED, EFFECT_SPORE
	db 33
	dw JUMPLUFF
	db SUNNY_DAY, SLEEP_POWDER, LEECH_SEED, EFFECT_SPORE
	db 38
	dw VENUSAUR
	...
	db 43
	dw CLEFAIRY
	db METRONOME, ENCORE, MOONLIGHT, DOUBLE_TEAM
	db -1 ; end
...
CamperGroup:
	...
	db 33
	dw GRAVELER
	db SELFDESTRUCT, ROCK_THROW, HARDEN, BULLDOZE
	db 33
	dw GRAVELER
	db SELFDESTRUCT, ROCK_THROW, HARDEN, BULLDOZE
	db 36
...
ExecutiveFGroup:
	...
	db 32
	dw VILEPLUME
	db MEGA_DRAIN, SWEET_SCENT, SLEEP_POWDER, SLUDGE
	db 32
	dw MURKROW
...
TwinsGroup:
	...
	db 16
	dw CLEFAIRY
	db GROWL, ENCORE, POUND, METRONOME
	db 16
	dw JIGGLYPUFF
...
RedGroup:
	...
	db 88
	dw PIKACHU
	db LIGHT_BALL, VOLT_TACKLE, IRON_TAIL, AGILITY, THUNDERBOLT
	dw MALE_DVS
	dw 50K, 65K, 55K, 65K, 65K ; 300k
	;   hp, atk, def, spd, spc
	db 85
	dw ESPEON
	db TWISTEDSPOON, CALM_MIND, SHADOW_BALL, MORNING_SUN, PSYCHIC_M
	dw MALE_DVS
	dw 60K, 50K, 60K, 65K, 65K ; 300k
	;   hp, atk, def, spd, spc
	db 85
	dw SNORLAX
	db CHESTO_BERRY, CURSE, REST, SLAM, SLEEP_TALK
	dw MALE_DVS
	dw 65K, 65K, 65K, 50K, 55K ; 300k
	;   hp, atk, def, spd, spc
	db 85
	dw CHARIZARD
	db DRAGON_FANG, DRAGON_DANCE, SACRED_FIRE, SLASH, DRAGON_CLAW
	dw MALE_DVS
	dw 60K, 65K, 60K, 65K, 50K ; 300k
	;   hp, atk, def, spd, spc
	db 85
	dw SCYTHER
	db FOCUS_BAND, SWORDS_DANCE, LEECH_LIFE, RAZOR_WIND, REVERSAL
	dw MALE_DVS
	dw 55K, 65K, 60K, 65K, 55K ; 300k
	;   hp, atk, def, spd, spc
	db 85
	dw LAPRAS
	db LEFTOVERS, CONFUSE_RAY, SURF, ICE_BEAM, RECOVER
	dw MALE_DVS
...
BlueGroup:
	...
	db 50
	dw RHYHORN
	db SOFT_SAND, EARTHQUAKE, ROCK_SLIDE, MEGAHORN, SLAM
	dw MALE_DVS
	dw 25K, 40K, 35K, 40K, 20K ; 160k
	;   hp, atk, def, spd, spc
	db 50
	dw SANDSLASH
	db FOCUS_BAND, SANDSTORM, SLASH, BULLDOZE, X_SCISSOR
	dw MALE_DVS
	dw 30K, 35K, 35K, 30K, 20K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw DUGTRIO
	db BLACKGLASSES, SWAGGER, DIG, PURSUIT, SLASH
	dw MALE_DVS
	dw 15K, 30K, 20K, 60K, 25K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw RHYDON
	db HARD_STONE, COUNTER, EARTHQUAKE, ROCK_SLIDE, HORN_DRILL
	dw SHINY_F_DVS
	dw 30K, 50K, 30K, 20K, 20K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw MAROWAK
	db THICK_CLUB, TAKE_DOWN, ROCK_SLIDE, BONEMERANG, BLIZZARD
	dw FEMALE_DVS
	dw 20K, 20K, 25K, 55K, 30K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw NIDOKING
	db POISON_BARB, POISON_JAB, EARTHQUAKE, SUBMISSION, THUNDERBOLT
	dw MALE_DVS
	...
	db 70
	dw PIDGEOT
	db SHARP_BEAK, TAKE_DOWN, WHIRLWIND, RAZOR_WIND, MIRROR_MOVE
	dw MALE_DVS
	dw 50K, 60K, 50K, 65K, 55K ; 280K
	;   hp, atk, def, spd, spc
	db 70
	dw ALAKAZAM
	db TWISTEDSPOON, THUNDER_WAVE, RECOVER, PSYCHIC_M, REFLECT
	dw MALE_DVS
	dw 50K, 50K, 50K, 65K, 65K ; 280K
	;   hp, atk, def, spd, spc
	db 70
	dw UMBREON
	db LEFTOVERS, MOONLIGHT, DARK_PULSE, TOXIC, PROTECT
	dw FEMALE_DVS
	dw 65K, 40K, 65K, 50K, 60K ; 280K
	;   hp, atk, def, spd, spc
	db 70
	dw GYARADOS
	db LUM_BERRY, DRAGON_DANCE, WATERFALL, EARTHQUAKE, HYPER_BEAM
	dw MALE_DVS
	dw 55K, 65K, 55K, 65K, 40K ; 280K
	;   hp, atk, def, spd, spc
	db 75
	dw VENUSAUR
	db MIRACLE_SEED, SUNNY_DAY, SLUDGE_BOMB, MORNING_SUN, SOLARBEAM
	dw MALE_DVS
	dw 65K, 40K, 60K, 50K, 65K ; 280K
	;   hp, atk, def, spd, spc
	db 70
	dw ARCANINE
	db CHARCOAL, HOWL, MORNING_SUN, SACRED_FIRE, EXTREMESPEED
	dw FEMALE_DVS
...
GruntFGroup:
	...
	db 18
	dw GLOOM
	db MEGA_DRAIN, SWEET_SCENT, EFFECT_SPORE, SLEEP_POWDER
	db -1 ; end
...
NekrobaGroup:
	...
	db 50
	dw ARBOK_DARK
	db POISON_FANG, CRUNCH, EARTHQUAKE, DRAGONBREATH
	dw MALE_DVS
	db "ARBOK@"
	db 51
	dw SNEASEL
	...
	db 52
	dw ARIADOS
	db LEECH_LIFE, POISON_JAB, TOXIC, NIGHT_SHADE
	dw SHINY_M_DVS
	db "PURPLE@"
	db 53
	dw SKARMORY
	db STEEL_WING, ROOST, DRILL_PECK, SPIKES
	dw MALE_DVS
	db "HALBIRD@"
	db 54
	dw ESPEON
...
DiogoGroup:
	...
	db 50
	dw BEEDRILL
	db FELL_STINGER, DOUBLE_TEAM, POISON_JAB, CUT
	dw FEMALE_DVS
	db "BEEDRILL@"
	db 51
	dw SCIZOR
	db SWORDS_DANCE, STEEL_WING, X_SCISSOR, PURSUIT
	dw MALE_DVS
	db "SCIZOR@"
	db 52
	dw WEAVILE
	db DOUBLE_TEAM, FAINT_ATTACK, LOW_KICK, ICICLE_CRASH
	dw FEMALE_DVS
	db "WEAVILE@"
	db 53
	dw CROBAT
	...
	db 54
	dw GLISCOR
	db SUBSTITUTE, EARTHQUAKE, ROOST, TOXIC
	dw MALE_DVS
	db "GLISCOR@"
	db 55
	dw PIDGEOT ;STARAPTOR
	db SKY_ATTACK, SUBMISSION, TAKE_DOWN, QUICK_ATTACK
	dw SHINY_M_DVS
	db "KAZE@"
	db -1 ; end
...
GreenGroup:
	...
	db 65
	dw BUTTERFREE
	db SILVERPOWDER, SAFEGUARD, SILVER_WIND, PSYBEAM, GIGA_DRAIN
	dw MALE_DVS
	dw 45K, 40K, 55K, 65K, 65K ; 270K
	;   hp, atk, def, spd, spc
	db 65
	dw NIDOQUEEN
	db SOFT_SAND, EARTHQUAKE, SLUDGE_BOMB, MOONLIGHT, COUNTER
	dw MALE_DVS
	dw 60K, 45K, 65K, 55K, 45K ; 270K
	;   hp, atk, def, spd, spc
	db 65
	dw CLEFABLE
	db LEFTOVERS, TRI_ATTACK, LIGHT_SCREEN, THUNDERBOLT, MOONLIGHT
	dw FEMALE_DVS
	dw 60K, 40K, 55K, 50K, 65K ; 270K
	;   hp, atk, def, spd, spc
	db 65
	dw VICTREEBEL
	db MIRACLE_SEED, SUNNY_DAY, MORNING_SUN, LEAF_BLADE, SLUDGE_BOMB
	dw MALE_DVS
	dw 40K, 55K, 50K, 65K, 60K ; 270K
	;   hp, atk, def, spd, spc
	db 70
	dw BLASTOISE
	db MYSTIC_WATER, HYDRO_PUMP, ICE_BEAM, RAPID_SPIN, EARTHQUAKE
	dw MALE_DVS
	dw 60K, 55K, 60K, 40K, 55K ; 270K
	;   hp, atk, def, spd, spc
	db 65
	dw NINETALES
	db CHARCOAL, FIRE_BLAST, PAIN_SPLIT, SOLARBEAM, SHADOW_BALL
	dw FEMALE_DVS
...
Gold1Group:
	...
	db 50
	dw BEEDRILL
	db SWORDS_DANCE, FELL_STINGER, SLUDGE_BOMB, PURSUIT
	dw MALE_DVS
	dw 25K, 50K, 20K, 50K, 15K ; 160k
	;   hp, atk, def, spd, spc
	db 50
	dw AZUMARILL
	db RAIN_DANCE, WATERFALL, SUBMISSION, ICE_PUNCH
	dw FEMALE_DVS
	dw 40K, 40K, 20K, 30K, 20K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw AMPHAROS
	db THUNDER, THUNDER_WAVE, FIRE_PUNCH, DRAGONBREATH
	dw MALE_DVS
	dw 20K, 35K, 25K, 30K, 40K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw MISMAGIUS
	db CONFUSE_RAY, SHADOW_BALL, FIRE_SPIN, PERISH_SONG
	dw FEMALE_DVS
	dw 20K,   0, 20K, 55K, 55K ; 150k
	;   hp, atk, def, spd, spc
	db 50
	dw DONPHAN
	db CURSE, EARTHQUAKE, SLAM, ICE_SHARD
	dw MALE_DVS
	dw 35K, 45K, 40K, 10K, 20K ; 150k
	;   hp, atk, def, spd, spc
	db 55
	dw MEGANIUM
	db PETAL_DANCE, MORNING_SUN, DRAGONBREATH, SLAM
	dw MALE_DVS
	...
	db 55
	dw TYPHLOSION
	db FIRE_BLAST, WILL_O_WISP, AURA_SPHERE, TAKE_DOWN
	dw MALE_DVS
	...
	db 55
	dw FERALIGATR
	db SURF, ICE_PUNCH, CRUNCH, SCREECH
	dw FEMALE_DVS
