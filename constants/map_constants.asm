...
; - scripts and events (see data/maps/scripts.asm)
	...
	map_const ECRUTEAK_SWARM_HOUSE,                         4,  4
...
;	map_const MOBILE_BATTLE_ROOM,                           5,  4 ;  6
	...
	map_const ONE_ISLAND_MART,                              6,  4 ;  1
	...
	map_const TWO_ISLAND_MART,                              6,  4 ;  1
	...
	map_const FIVE_ISLAND_MART,                             6,  4 ;  1
	...
	map_const SIX_ISLAND_MART,                              6,  4 ;  1
	...
	map_const SEVEN_ISLAND,                                14, 16
	map_const SEVEN_ISLAND_MART,                            6,  4 ;  1
