; MoveEffectsPointers indexes (see data/moves/effects_pointers.asm)
	...
	const EFFECT_SPEED_DOWN_MULTI_HIT
	...
	const EFFECT_SKY_ATTACK         ;unused?
...
;	const EFFECT_MAGNITUDE
	...
	const EFFECT_EFFECT_SPORE
	const EFFECT_COIL
	const EFFECT_VENOMSTRIKE
	const EFFECT_HONE_CLAWS
	const EFFECT_SP_ATK_UP_2
	const EFFECT_NIGHTMARE_HIT
	const EFFECT_SPIDER_WEB
	const EFFECT_HOWL
	...
	const EFFECT_LASER_FOCUS
	const EFFECT_NEGATIVE_PRIORITY_HIT
	const EFFECT_ACID_RAIN
	const EFFECT_DIVE
	const EFFECT_DIG
	...
	const EFFECT_MIRACLE_EYE
	const EFFECT_CORROSION
	const EFFECT_ACIDDOWNPOUR
	const EFFECT_ACID
	...
	const EFFECT_DISABLE_HIT
	const EFFECT_SHELL_SMASH
	const EFFECT_AURORA_VEIL
	const EFFECT_LANDS_WRATH
