...
; battle types (wBattleType values)
	...
	const BATTLETYPE_SET_NO_ITEMS
	const BATTLETYPE_SWITCH_NO_ITEMS
...
; wPlayerSubStatus5 or wEnemySubStatus5 bit flags
	...
	const SUBSTATUS_MIRACLE_EYE
	const SUBSTATUS_CORROSION
